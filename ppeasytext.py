...
#6
cloth_desc = 'This is a cloth gown. It must be worn while providing care to patients who are in isolation. A cloth gown differs from a plastic down because it will allow fluids to penetrate the cloth and touch your body. \n\nIts NOT recommended to wear a cloth gown while caring for patients with C-diff or TB.'

#7
plastic_desc = 'This is a plastic gown. Plastic gowns is different from a cloth gown because they are fluid-resistant and impermeable. They will not allow fluids to penetrate the gown and touch your body. \n\nIt must be worn while providing care to C-Diff patients. Its is also recommended to wear a plastic gown while providing care to patients with TB.'
...
#11
oxi_desc = 'Oxivir is recommended for general disinfecting. The active ingredient hydrogen peroxide. It is less harsh than most other disinfectants. \n\nIt has a very short dwell time of just \n1 minute. \n\nIt does NOT kill the bacteria that causes C-Diff and should never be used to disinfect anything that may be contaminated with C-Diff.'

#12
sani_desc = 'Sani is recommended for general disinfecting. The active ingredient is Alcohol. Be carful when using Alcohol. Inhaling Alcohol vapors can cause nausea, irritation of the nose, throat, and even difficulty with breathing. \n\nAlcohol Sani wipes I have a dwell time of 2 minutes \n\nIt does NOT kill the bacteria that causes C-Diff and should never be used to disinfect anything that may be contaminated nwith C-Diff.'

#13
bleach_desc = 'Bleach is a Sporicidal disinfectant. The active ingredient is Sodium hypochlorite. \n\nBleach kills the bacteria that causes C-Diff and should always be used to disinfect anything that may be contaminated with C-Diff.\n\nNever mix bleach and ammonia. Mixing the to chemicals produces chlorine gas which cam be deadly.'
